<html>
    ...
    <body>
        ...
        <form action="<?php echo filter_input(INPUT_SERVER, "PHP_SELF"); ?>" method="get">
            ...
            <input type="checkbox" name="categoria[]" value="cosmetica" <?php if (filter_has_var(INPUT_GET, "categoria") && $campos["categoria"] != "Invalido" && in_array("cosmetica", $campos["categoria"])) echo "checked"; ?>>
            <label>cosmetica</label>
            <input type="checkbox" name="categoria[]" value="hogar" <?php if (filter_has_var(INPUT_GET, "categoria") && $campos["categoria"] != "Invalido" && in_array("hogar", $campos["categoria"])) echo "checked"; ?>>
            <label>hogar</label>
            <input type="checkbox" name="categoria[]" value="alimentacion" <?php if (filter_has_var(INPUT_GET, "categoria") && $campos["categoria"] != "Invalido" && in_array("alimentacion", $campos["categoria"])) echo "checked"; ?>>
            <label>alimentacion</label>
            <input type="checkbox" name="categoria[]" value="textil" <?php if (filter_has_var(INPUT_GET, "categoria") && $campos["categoria"] != "Invalido" && in_array("textil", $campos["categoria"])) echo "checked"; ?>>
            <label>textil</label>      
